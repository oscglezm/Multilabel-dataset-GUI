...
public class metric_output extends javax.swing.JFrame {
    ...
    public metric_output(MultiLabelInstances dataset , String label1, String label2, int posx, int posy , boolean es_de_tipo_meka )
    {
        ...
        else 
        {
         ...
         //para imprimir datos de los label en la pestaña label x examples
     public metric_output(MultiLabelInstances dataset, String labelname, int examples_pos, int posx, int posy, boolean es_de_tipo_meka)
     {
        this.posx = posx;
        this.posy = posy;
        ...
        print_information(dataset,labelname,examples_pos);
    ...
    private void print_information(MultiLabelInstances dataset, String labelname, int examples_pos)// para imprimir informacion acerca de cada etiqueta
    {
        String tabs ="\t"+"\t" +"\t";
        String tabs2 = "\t"+"\t";
        String tabs1 = "\t";
        
        int ex_neg = dataset.getNumInstances() - examples_pos;
        
        double freq = examples_pos/(dataset.getNumInstances()*1.0);
        String truncate = util.Truncate_values_aprox_zero(Double.toString(freq), 5);
                
         jTextArea1.append("Label: "+tabs+labelname+"\n");
         jTextArea1.append("Examples (+): "+tabs+examples_pos+"\n");
         jTextArea1.append("Examples (-): "+tabs+ex_neg+"\n");
         jTextArea1.append("Frequency: "+tabs+truncate+"\n");
    }
    //IR per labelset
