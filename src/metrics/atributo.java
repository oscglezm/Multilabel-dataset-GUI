...
public class atributo {
    ...
    public atributo(String name, int frequency)
    {
        this.name = name;
    ...
    public atributo(String name, double ir, double variance)
    {
        this.name = name;
        frequency =-1;
        this.ir = ir;
    ...
    public atributo(String name, int frequency, double ir)
    {
        this.name = name;
        this.frequency=frequency ;
        this.ir = ir;
    ...
    public atributo(String name, int frequency, double ir, double variance, double ir_inter_class)
    {
        this.name = name;
        this.frequency=frequency ;
        this.ir = ir;
