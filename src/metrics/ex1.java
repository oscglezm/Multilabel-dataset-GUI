...
public class ex1 extends javax.swing.JFrame {
    ...
    String filename_database_arff_test,filename_database_arff =null;
   ...
   */
      ...
      Border my_border = LineBorder.createGrayLineBorder();
     
      
      chi = new JLabel("Chi");
      chi.setBounds(0,80, 22,20);
      chi.setBackground(Color.white);
      chi.setForeground(Color.black);
      chi.setOpaque(true);
      chi.setBorder(my_border);
      chi.setHorizontalAlignment(SwingConstants.CENTER);
      ...
      fi.setBounds(300,0, 22,20);
      fi.setBackground(Color.gray);
      fi.setForeground(Color.white);
      fi.setOpaque(true);
      fi.setBorder(my_border);
      
      Font font = fi.getFont();
      Font font_chi = chi.getFont();
      
       // same font but bold
      Font boldFont = new Font(font.getFontName(), Font.BOLD, font.getSize());
      Font boldFont_chi = new Font(font_chi.getFontName(), Font.BOLD, font_chi.getSize());
      
      fi.setFont(boldFont);
      chi.setFont(boldFont_chi);
...
private void Inicializa_config()
{
     ...
     // jTable1.setVisible(true);        
      ...
      // cp_ir_x_label_intra_class = create_jchart(jPanel11, "line_2_axis", "Label id","IR values",true);
        cp_ir_x_label_intra_class = create_jchart(jPanel11, "line", "Label id","# Labels",true);
       //cp_ir_x_label_inter_class = create_jchart(jPanel27, "line_2_axis", "Label id","IR values",true);
       cp_ir_x_label_inter_class = create_jchart(jPanel27, "line", "Label id", "# Labels",true);
    ...
    private void create_jtable_metrics_jpanel1(final JTable jtable ,JPanel jpanel , JButton button_all, JButton button_none, JButton button_invert, JButton button_calculate,JButton button_save, int posx,int posy, int width, int heigh,String info)
    {
     ...
     //button NONE
      ...
      jpanel.add(button_save);
             ...
             //button SAVE
      button_save = new JButton("Save dataset as...");
      button_save.setBounds(posx+375, posy+heigh+45, 125, 20);
            
      button_save.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    button_saveActionPerformed_dataset_as(evt,jtable);
                } catch (IOException ex) {
                    Logger.getLogger(ex1.class.getName()).log(Level.SEVERE, null, ex);
                }
                            }
  ...
  //"choose datasets" PESTAÑA
    ...
    private void initComponents() {
        ...
        jTabbedPane3.addTab("Imbalanced data metrics ", jPanel20);
        ...
        jLabel27.setText("When IR> 1.5 label is imbalanced");
        ...
        jTabbedPane1.addTab("Imbalanced data", jPanel9);
        ...
        jLabel30.setText("Labels are dependent when the value of Chi coefficient is above 6.635");
        ...
        jTabbedPane4.addTab("Chi & Phi coefficient", jPanel24);
        ...
        jTabbedPane1.addTab("Dependence", jPanel21);
    ...
    private void jTable4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable4MouseClicked
         ...
         else if(jTabbedPane3.getSelectedIndex()==3) // si esta activado el panel del IR per Label intra class
        {
         ...
         else if(jTabbedPane3.getSelectedIndex()==0) // si esta activado el panel Label per Examples
         {
             int seleccionada = jTable4.getSelectedRow();
             
             String label_name = (String)jTable4.getValueAt(seleccionada, 0);
             int examples_pos =  (int)jTable4.getValueAt(seleccionada, 1);
             
            int posx = this.getBounds().x;
            int posy = this.getBounds().y;

            metric_output mo = new metric_output(dataset,label_name,examples_pos,posx, posy+50,es_de_tipo_meka);
  ...
  //OPTION "Ramdon  split"  
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (returnVal == JFileChooser.OPEN_DIALOG)
        {
            ...
            filename_database_arff = f1.getAbsolutePath();
     ...
     private void button_saveActionPerformed(java.awt.event.ActionEvent evt, JTable jtable) throws IOException
    {
     ...
     //BOTON SALVAR DATASET AS... EN LA PESTAÑA DATABASE
     private void button_saveActionPerformed_dataset_as(java.awt.event.ActionEvent evt, JTable jtable) throws IOException
    {
       ...
       // JFILECHOOSER SAVE
         ...
         // extension txt
        FileNameExtensionFilter fname = new FileNameExtensionFilter("MULAN-arff", "MULAN-arff");
        FileNameExtensionFilter fname3 = new FileNameExtensionFilter("MEKA-arff", "MEKA-arff");
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION)
        {
                ...
                if(f1.getDescription().equals("MEKA-arff")) //para guardarlo en formato MEKA
                {
                    ...
                    FileReader fr = new FileReader(filename_database_arff);
                    BufferedReader bf = new BufferedReader(fr);
                    
                    String sCadena = "",relation_name,tipo_formato="",mod;
                    boolean flag_data=false;

                    //saber que tipo de dataset es TIPO_A o TIPO_B
                    while ((sCadena = bf.readLine())!=null) 
                        {
                            if(sCadena.indexOf("@data")!=-1) {flag_data = true;continue;}
                            
                            if(sCadena.trim().length()==0 ) continue;                            
                            
                            if(flag_data)
                            {
                                tipo_formato= util.Get_tipo_formato(sCadena);
                                break;
                            }
                        }
                    ...
                    if(tipo_formato.equals("tipo_B")) //SI ES DE TIPO B
                    {
                        
                         while ((sCadena = bf.readLine())!=null) //hacer la parte de mulan de tipo B
                        {
                            if(sCadena.indexOf("@relation")!=-1) 
                            {
                                String temp ="@relation '"+dataset.getDataSet().relationName()+": -C "+dataset.getNumLabels()+"'";
                                wr.write(temp);//escribe en el fichero
                                wr.write(System.getProperty("line.separator"));// escribe el salto de linea
                                
                                continue;
                            }
                             
                            wr.write(sCadena);//escribe en el fichero
                            wr.write(System.getProperty("line.separator"));// escribe el salto de linea
                        }
                        
                    }
                    
                    else //SI ES DE TIPO A
                    {
                        //...
                        boolean flag= false, flag_labels = false; 
                        flag_data =false;
                        ArrayList<String>  labels_lines = new ArrayList();
                        int count_label=0, cant_labels= dataset.getNumLabels();
                        int total_attr= dataset.getFeatureAttributes().size();
                    
                        
                        while ((sCadena = bf.readLine())!=null) //hacer la parte de mulan de tipo B
                        {
                            
                                if(sCadena.trim().length()==0 && flag_labels ) //imprime las etiquetas
                                {
                                    for( String current : labels_lines)
                                    {
                                     wr.write(current);//escribe en el fichero
                                     wr.write(System.getProperty("line.separator"));// escribe el salto de linea
                                    }
                            ...
                            if(sCadena.trim().length()==0 && flag)
                            {
                                wr.write(System.getProperty("line.separator"));// escribe el salto de linea
                                System.out.println("hay una linea vacia"); 
                                continue;
                            }
                            
                            if(sCadena.indexOf("%") != -1) {continue;} //tiene algun comentario
                            
                            
                            if(sCadena.indexOf("@relation")!=-1) // PRIMER FLAG, EL DE INICIO
                            {
                                String temp ="@relation '"+dataset.getDataSet().relationName()+": -C "+dataset.getNumLabels()+"'";
                                wr.write(temp);//escribe en el fichero
                                wr.write(System.getProperty("line.separator"));// escribe el salto de linea
                           ...
                           if(sCadena.indexOf("@data") != -1) //HABILITA LA PARTE DE LOS DATOS (flag_data) Y DESHABILITA LA PRIMERA PARTE (flag)
                            {
                                flag_data= true; 
                                flag=false; 
                           ...
                           // ESTA EN LA PARTE DE LAS ETIQUETAS flag
                           if(flag)
                           {
                               if(count_label< total_attr) //GUARDAR LAS ETIQUETAS PARA INSERTARLOS AL FINAL DE TODOS LOS ATRIBUTOS
                               {
                                 flag_labels=true;
                                  
                                 labels_lines.add(sCadena);
                            ...
                            // ESTA EN LA PARTE DE LOS DATOS flag_data
                           if(flag_data)
                                {
                                   mod = util.transforma_cadena_tipo_A(sCadena, total_attr);
                                
                                    // System.out.println("cadena cambiada "+mod );
                                
                                    wr.write(mod);//escribe en el fichero
                                    wr.write(System.getProperty("line.separator"));// escribe el salto de linea
                ...
                //COMPROBAR SI TIENE SENTIDO SALVAR UNA SOLA LINEA.
               else if (f1.getDescription().equals("MULAN-arff"))//para guardarlo en formato MULAN
                {
                    ...
                    // CONOCER QUE TIPO DE FORMATO DE MEKA ES
                    
                    boolean flag_data1=false;
                    
                      while ((sCadena = bf.readLine())!=null) 
                        {
                            if(sCadena.indexOf("@data")!=-1) {flag_data1 = true;continue;}
                  ...
                  //--------------------------------------------------------------------
                    ...
                    int cant_labels=0,count_label=0;
            
                    ArrayList<String> labels_lines = new ArrayList();
                    boolean flag = false, flag_data=false,flag_labels=true;
               
            
                    //convirtiendo arff MEKA
                    while ((sCadena = bf.readLine())!=null) 
                        {
                            ...
                            if(sCadena.indexOf("@relation") != -1) //extraer la cantidad de etiquetas
                            {
                                cant_labels =util.Extract_labels_from_arff(sCadena); //extrae la cantidad de etiquetas
                                relation_name = util.Extract_relation_name(sCadena); // extrae el relation name
                    
                                wr.write("@relation "+relation_name);//escribe en el fichero
                                wr.write(System.getProperty("line.separator"));// escribe el salto de linea
                                wr.write(System.getProperty("line.separator"));// escribe el salto de linea
                    
                                //System.out.println("el relation names es "+relation_name);
                           ...
                           // ESTA EN LA PARTE DE LAS ETIQUETAS flag
                           if(tipo_formato.equals("tipo_A") && flag)
                           {
                               if(count_label< cant_labels) //GUARDAR LAS ETIQUETAS PARA INSERTARLOS AL FINAL DE TODOS LOS ATRIBUTOS
                               {
                                 flag_labels=true;
                           ...
                           else if (tipo_formato.equals("tipo_B") && flag)
                           {
                                 wr.write(sCadena);//escribe en el fichero
                                 wr.write(System.getProperty("line.separator"));// escribe el salto de linea
                                 continue;
                           ...
                           // ESTA EN LA PARTE DE LOS DATOS flag_data
                           if(tipo_formato.equals("tipo_A") && flag_data)
                                {
                                   mod = util.transforma_cadena_tipo_A(sCadena, cant_labels);
                            ...
                            if(tipo_formato.equals("tipo_B") && flag_data)
                                {
                   ...
                   // GENERA EL XML
                    String[] labels=dataset.getLabelNames();
                    
                    String path_xml = file.getAbsolutePath() +".xml";
                    System.out.println("ruta del xml es: "+ path_xml);
                    
                    BufferedWriter bw_xml = new BufferedWriter(new FileWriter(path_xml));
                    PrintWriter wr_xml = new PrintWriter(bw_xml);
                    
                    util.Write_into_xml_file(wr_xml,labels);
