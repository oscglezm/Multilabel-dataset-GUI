...
public class pares_atributos 
{
    ...
    public pares_atributos(String attr1, String attr2,int cant_veces)
    {
        this.attr1 = attr1;
        this.attr2 = attr2;
        ...
        public pares_atributos(String attr1, String attr2,int cant_veces, int ind_att1, int ind_att2, int cant_att1, int cant_att2)
    {
        this.attr1 = attr1;
        this.attr2 = attr2;
        this.cant_veces = cant_veces;
